...
let producer_identifier { producer_identifier;_ } : identifier =
  Positions.value producer_identifier

let producer_identifier_located { producer_identifier;_ } : identifier located =
  producer_identifier

let producer_symbol { producer_symbol ;_ } =
  producer_symbol

let producer_attributes { producer_attributes; _ } =
  producer_attributes
